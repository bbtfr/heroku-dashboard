...
describe Heroku::AccountsController do
  ...
  # Heroku::AccountsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET new" do
    it "assigns a new heroku_account as @heroku_account" do
      get :new, {}, valid_session
      assigns(:heroku_account).should be_a_new(Heroku::Account)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Heroku::Account" do
        expect {
          post :create, {:heroku_account => valid_attributes}, valid_session
        }.to change(Heroku::Account, :count).by(1)
      end

      it "assigns a newly created heroku_account as @heroku_account" do
        post :create, {:heroku_account => valid_attributes}, valid_session
        assigns(:heroku_account).should be_a(Heroku::Account)
        assigns(:heroku_account).should be_persisted
      end

      it "redirects to the created heroku_account" do
        post :create, {:heroku_account => valid_attributes}, valid_session
        response.should redirect_to(Heroku::Account.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved heroku_account as @heroku_account" do
        # Trigger the behavior that occurs when invalid params are submitted
        Heroku::Account.any_instance.stub(:save).and_return(false)
        post :create, {:heroku_account => { "apikey" => "invalid value" }}, valid_session
        assigns(:heroku_account).should be_a_new(Heroku::Account)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested heroku_account" do
        ...
        Heroku::Account.any_instance.should_receive(:update).with({ "apikey" => "MyString" })
        put :update, {:id => account.to_param, :heroku_account => { "apikey" => "MyString" }}, valid_session
      end
